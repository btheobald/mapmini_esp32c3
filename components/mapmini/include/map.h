...
int load_map(arena_t* a0, char* filename, way_prop** way_list_ptr, uint32_t x_in, uint32_t y_in, uint32_t z_in, int16_t x0, int16_t y0, uint16_t st, float rot, float size);
